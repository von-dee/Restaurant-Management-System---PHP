        ...
        <div class="ms-panel-body p-0">
          <div class="ms-email-aside">
            ...
            <ul class="ms-list ms-email-list">
              ...
              <li class="ms-list-item"> <a href="#"><i class="material-icons">folder</i> Social Media <span>123</span> </a> 
              </li>
              <li class="ms-list-item"> <a href="#"><i class="material-icons">folder</i> Promotions <span>175</span> </a> 
              </li>
              <li class="ms-list-item"> <a href="#"><i class="material-icons">folder</i> Updates <span>12</span> </a> 
              </li>
            </ul>
            ...
            <div class="ms-email-header">
              <ul class="ms-email-options">
                <li>
                  ...
                  <div class="dropdown"> <a href="#" class="has-chevron" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Select
                    </a>
            ...
            <div class="ms-email-content">
              <ul class="ms-scrollable ps ps--active-y">
                ...
                <li class="media ms-email clearfix">
                  ...
                  <div class="ms-email-img mr-3 ">
                    <img src="media/img/costic/customer-4.jpg" class="ms-img-round" alt="people">
                  </div>
                  <div class="media-body ms-email-details"> <span class="ms-email-sender">John Doe</span>
                    <h6 class="ms-email-subject">[WordPress] New Comment</h6>  <span class="ms-email-time">2 Hours ago</span>
                    <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                ...
                <li class="media ms-email clearfix">
                  ...
                  <div class="ms-email-img mr-3 ">
                    <img src="media/img/costic/customer-5.jpg" class="ms-img-round" alt="people">
                  </div>
                  <div class="media-body ms-email-details"> <span class="ms-email-sender">John Doe</span>
                    <h6 class="ms-email-subject">[WordPress] New Comment</h6>  <span class="ms-email-time">2 Hours ago</span>
                    <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                ...
                <li class="media ms-email clearfix">
                  ...
                  <div class="ms-email-img mr-3 ">
                    <img src="media/img/costic/customer-6.jpg" class="ms-img-round" alt="people">
                  </div>
                  <div class="media-body ms-email-details"> <span class="ms-email-sender">John Doe</span>
                    <h6 class="ms-email-subject">[WordPress] New Comment</h6>  <span class="ms-email-time">2 Hours ago</span>
                    <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                ...
                <li class="media ms-email pinned clearfix">
                  ...
                  <div class="ms-email-img mr-3 ">
                    <img src="media/img/costic/customer-7.jpg" class="ms-img-round" alt="people">
                  </div>
                  <div class="media-body ms-email-details"> <span class="ms-email-sender">John Doe</span>
                    <h6 class="ms-email-subject">[WordPress] New Comment</h6>  <span class="ms-email-time">2 Hours ago</span>
                    <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                ...
                <li class="media ms-email clearfix">
                  ...
                  <div class="ms-email-img mr-3 ">
                    <img src="media/img/costic/customer-8.jpg" class="ms-img-round" alt="people">
                  </div>
                  <div class="media-body ms-email-details"> <span class="ms-email-sender">John Doe</span>
                    <h6 class="ms-email-subject">[WordPress] New Comment</h6>  <span class="ms-email-time">2 Hours ago</span>
                    <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                ...
                <li class="media ms-email pinned clearfix">
                  ...
                  <div class="ms-email-img mr-3 ">
                    <img src="media/img/costic/customer-9.jpg" class="ms-img-round" alt="people">
                  </div>
                  <div class="media-body ms-email-details"> <span class="ms-email-sender">John Doe</span>
                    <h6 class="ms-email-subject">[WordPress] New Comment</h6>  <span class="ms-email-time">2 Hours ago</span>
                    <p class="ms-email-msg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
              ...
              <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 918px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 700px;"></div></div></ul>
            </div>
          </div>
        </div>
      </div>
