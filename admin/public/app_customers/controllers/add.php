  ...
  class add extends \setup { 
      ...
      function Init(){
        // if($this->engine->validatePostForm($this->microtime)){  
          $gen_staff_code =  $this->engine->generateCode_SQL("app_customers", "STF", "STF_CODE", "STF_ID");
          ...
          $stmt =$this->sql->Execute($this->sql->Prepare("INSERT INTO app_customers (STF_CODE,
          STF_FIRSTNAME,
          STF_LASTNAME,
          STF_DATEOFBIRTH,
          STF_PHONE,
