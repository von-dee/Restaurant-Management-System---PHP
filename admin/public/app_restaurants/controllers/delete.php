  ...
  class delete extends \setup { 
      ...
      function Init(){
        // if($this->engine->validatePostForm($this->microtime)){  
          ...
          $stmt = $this->sql->Execute($this->sql->Prepare("UPDATE app_restaurants SET STF_STATUS = '0' WHERE STF_CODE = ".$this->sql->Param('a')." AND STF_ACTORCOMPCODE = ".$this->sql->Param('a')),array($this->keys,$actorcompcode));
