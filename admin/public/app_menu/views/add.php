<div class="ms-content-wrapper">
    ...
    margin-right: 1em;height: 2em;padding: 0;" onclick="$('#pg').val('app_menu');$('#view').val('add');$('#class_call').val('');$('#keys').val('');document.myform.submit();">
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="validationCustom18" name="productTitle" placeholder="Product Name" value="" required="">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="productQuantity" id="validationCustom24" placeholder="00" required="">
                      <div class="invalid-feedback">
                        Quantity
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="productCost" id="validationCustom25" placeholder="₵00.00" required="">
                      <div class="invalid-feedback">
                        Cost Price
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="productPrice" id="validationCustom25" placeholder="₵00.00" required="">
                      <div class="invalid-feedback">
                        Selling Price
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      <textarea rows="5"  name="productDescription"  id="validationCustom12" class="form-control" placeholder="Description" required=""></textarea>
                      <div class="invalid-feedback">
