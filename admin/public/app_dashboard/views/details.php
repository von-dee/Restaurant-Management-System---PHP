                    ...
                    <div class="align-items-center">
							...
							<div class="col-lg-5">
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<span class="shipper_note"><?php echo $paging['REQ_REQUEST_CODE']; ?> </span>
									</div>
									<div class="col-lg-6">
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<span class="shipper_note"><?php echo $paging['REQ_LOCATION_FROM']; ?>  </span>
									</div>
									<div class="col-lg-6">
										<span>Destination (To)</span> <br>
										<span class="shipper_note"><?php echo $paging['REQ_LOCATION']; ?> </span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row det_container">
								...
								<div class="row">
									<div class="col-lg-4">
										<span>Item Type<span> <br>
												<span class="shipper_note"> <?php echo $paging['REQ_ITEMS']; ?> </span>
									</div>
									<div class="col-lg-4">
										<span>Total Quantity</span> <br>
										<span class="shipper_note"> <?php echo $paging['REQ_TOTAL_ITEMS']; ?> </span>
									</div>
									<div class="col-lg-4">
										<span>Total Amount</span> <br>
										<span class="shipper_note"> <?php echo $paging['REQ_TOTAL_AMOUNT']; ?> </span>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
							...
							<div class="col-lg-5">
								...
								<div class="row">
									<div class="col-lg-4">
										<span>Date<span> <br>
												<span class="shipper_note"> <?php echo preg_replace("/\s.*$/","",$paging['REQ_PICKUP_DATE']); ?> </span>
									</div>
									<div class="col-lg-4">
										<span>Time</span> <br>
										<span class="shipper_note"> <?php echo $paging['REQ_PICKUP_TIME']; ?> </span>
									</div>
									<div class="col-lg-4">
								...
								<div class="row">
									<div class="col-lg-12">
										<p class="note_marg_top">
											...
											<span class="shipper_note"> <?php echo $paging['REQ_DESCRIPTION']; ?>. 
											</span>
										</p>
						...
						<div class="row det_container">
								...
								<div class="row">
									<div class="col-lg-6">
										<p>
											...
											<span class="shipper_note"> <?php echo $paging['REQ_REQUESTORNAME']; ?> </span>
										</p>
									</div>
									<div class="col-lg-6">
										<p>
											<span>Phone Number</span> <br>
											<span class="shipper_note"> <?php echo $paging['REQ_REQUESTOR_PHONE']; ?> </span>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
								...
								<?php 
									if( empty($paging['REQ_RIDERNAME']) && empty($paging['REQ_RIDERPHONE'])){
								?>
								...
								?>
									...
									<div>
										...
										<div class="row note_marg_top">
											<div class="col-lg-6">
												<span>Fullname<span> <br>
														<span class="shipper_note"> <?php echo $paging['REQ_RIDERNAME']; ?> </span>
											</div>
											<div class="col-lg-6">
												<span>Phone Number</span> <br>
												<span class="shipper_note"> <?php echo $paging['REQ_RIDERPHONE']; ?> </span>
											</div>
										</div>
										...
										<div class="row note_marg_top">
											<div class="col-lg-6">
												<span>Company's Name<span> <br>
														<span class="shipper_note"> <?php echo $paging['REQ_RIDER_COMP_NAME']; ?>  </span>
											</div>
											<div class="col-lg-6">
												<span>Company's Number</span> <br>
												<span class="shipper_note"> <?php echo $paging['REQ_RIDER_COMP_PHONE']; ?>  </span>
											</div>
										</div>
