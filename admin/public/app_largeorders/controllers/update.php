  ...
  class update extends \setup { 
      ...
      function Init(){
        // if($this->engine->validatePostForm($this->microtime)){  
          ...
          $stmt = $this->sql->Execute($this->sql->Prepare("UPDATE app_reservations SET 
          RES_STATUS = ".$this->sql->Param('a')." WHERE  RES_CODE = ".$this->sql->Param('a')." "),array($this->ekeys, $this->keys));
