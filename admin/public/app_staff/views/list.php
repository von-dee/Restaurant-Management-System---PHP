...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
				<button class="btn btn-primary-rgba" onclick="$('#pg').val('app_staff');$('#view').val('add');$('#class_call').val('');$('#keys').val('');document.myform.submit();"> Add New &nbsp; <i class="feather icon-plus-square"></i></button>
            </div>                        
        </div>
    </div>          
</div>
										...
										<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
											...
											<tbody>
												...
												<tr role="row" class="odd">
													...
													<td><?php echo $val['STF_LASTNAME'].' '.$val['STF_FIRSTNAME']; ?></td>
