		...
		<div class="card-body">
			<div class="table-responsive">
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 style="text-align: center; font-weight: 800;border-bottom: 1px solid #dedede;padding-bottom: 0.5em;margin-bottom: 1em;">COMPANY'S CLIENTS REPORT</h4>
						</div>
							...
							<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
								...
								<thead>
									<tr role="row">
										...
										<th class="sorting_asc" tabindex="0" aria-controls="dataTable" 				rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Name: activate to sort column descending"
											style="width: 130px;">Full Name</th>
										...
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
											...
											style="width: 130px;">User Type</th>
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
								...
								<tbody>
									...
									<tr role="row" class="odd">
										...
										<td><?php echo $val['USR_ACCESS_LEVEL']; ?></td>
										<td><?php echo $val['USR_DATE_ADDED']; ?></td>
									</tr>
