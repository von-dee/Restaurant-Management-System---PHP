<?php  
$export_url = "./public/app_reports/excelreports/ex_trips/filter.php";
...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">All Trips</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
					<li class="breadcrumb-item"><a href="#">Reports</a></li>
					<li class="breadcrumb-item"><a href="#">All Trips</a></li>
		...
		<div class="card-body">
			<div class="table-responsive">
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 style="text-align: center; font-weight: 800;border-bottom: 1px solid #dedede;padding-bottom: 0.5em;margin-bottom: 1em;">COMPANY'S ALL TRIPS REPORT</h4>
						</div>
						...
						<div class="col-sm-6">
							...
							<p style="margin: 5px;">
								<b>Description</b> : <span> This is a report on your Trips between the dates above. </span>
							</p>
						</div>
