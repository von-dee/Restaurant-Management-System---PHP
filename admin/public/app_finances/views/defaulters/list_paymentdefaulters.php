...
<?php //echo "LIST ";
$rs= $paging_paymentdefaulters->paginate();
?>
							...
							<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4" style="padding: 2em;">
								<div class="row align-items-center">
									...
									<div class="col-sm-12 col-md-2">
										<div>
											<?php echo $paging_paymentdefaulters->renderFirst('<span class="fa fa-angle-double-left"></span>');?>
											<?php echo $paging_paymentdefaulters->renderPrev('<span class="fa fa-arrow-circle-left"></span>','<span class="fa fa-arrow-circle-left"></span>');?>
											<input name="page" size="5" type="text" class="pagedisplay short pag_input" value="<?php echo $paging_paymentdefaulters->renderNavNum();?>" readonly />
											<?php echo $paging_paymentdefaulters->renderNext('<span class="fa fa-arrow-circle-right"></span>','<span class="fa fa-arrow-circle-right"></span>');?>
											<?php echo $paging_paymentdefaulters->renderLast('<span class="fa fa-angle-double-right"></span>');?>
											<?php $paging_paymentdefaulters->limitList($list->limit,"myform");?>
										</div>
									</div>	
										...
										<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
											...
											<tbody>
												<?php 
													...
													if($paging_paymentdefaulters->total_rows > 0 ){
													...
													<td> 
														<div class="row">
															...
															<div class="col-sm-12 col-md-8">
																<a  href="javascript:void(0);" onclick="$('#pg').val('app_finances');$('#view').val('paymentdefaulters_details');$('#class_call').val('details');$('#keys').val('<?php echo $data; ?>');document.myform.submit();" class="btn btn-primary btn-icon-split" >
								...
								<div class="row">
									<div class="col-sm-12 col-md-5">
										...
										Showing <?php echo $paging_paymentdefaulters->renderNavNum();?>of <?php echo $paging_paymentdefaulters->max_pages; ?> pages
											<span class="separator">|</span>

											Total <?php  echo $paging_paymentdefaulters->total_rows; ?> records
