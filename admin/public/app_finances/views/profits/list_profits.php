...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Profits</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
					<li class="breadcrumb-item"><a href="#">Finances</a></li>
                    <li class="breadcrumb-item"><a href="#">Profits</a></li>
                </ol>
            </div>
        </div>
							...
							<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4" style="padding: 2em;">
								<div class="row align-items-center">
									...
									<div class="col-sm-12 col-md-2">
										<div>
											<?php echo $paging_profits->renderFirst('<span class="fa fa-angle-double-left"></span>');?>
											<?php echo $paging_profits->renderPrev('<span class="fa fa-arrow-circle-left"></span>','<span class="fa fa-arrow-circle-left"></span>');?>
											<input name="page" size="5" type="text" class="pagedisplay short pag_input" value="<?php echo $paging_profits->renderNavNum();?>" readonly />
											<?php echo $paging_profits->renderNext('<span class="fa fa-arrow-circle-right"></span>','<span class="fa fa-arrow-circle-right"></span>');?>
											<?php echo $paging_profits->renderLast('<span class="fa fa-angle-double-right"></span>');?>
											<?php $paging_profits->limitList($list->limit,"myform");?>
										</div>
									</div>	
										...
										<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting_asc" tabindex="0" aria-controls="dataTable" 			rowspan="1" colspan="1" aria-sort="ascending"
														aria-label="Name: activate to sort column descending"
														style="width: 150px;">Transaction Date</th>
													<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
														colspan="1" aria-label="Position: activate to sort column ascending"
														style="width: 140px;">Profit Amount</th>
													<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
														colspan="1" aria-label="Office: activate to sort column ascending"
														style="width: 120px;">Payment Type</th>
													<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
														colspan="1" aria-label="Age: activate to sort column ascending"
														style="width: 120px;">Payment Mode</th>
													<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
											...
											<tbody>
												<?php 
													...
													if($paging_profits->total_rows > 0 ){
								...
								<div class="row">
									<div class="col-sm-12 col-md-5">
										...
										Showing <?php echo $paging_profits->renderNavNum();?>of <?php echo $paging_profits->max_pages; ?> pages
											<span class="separator">|</span>

											Total <?php  echo $paging_profits->total_rows; ?> records
