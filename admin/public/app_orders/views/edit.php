          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              ...
              <div class="invoice-buttons text-right"> 
				        <a href="#" class="btn btn-danger mr-2"  onclick="$('#pg').val('app_orders');$('#view').val('');$('#class_call').val('update');$('#ekeys').val('0');$('#keys').val('<?php echo $result['CHKOUT_CODE']; ?>');document.myform.submit();">Cancel Order</a>
                <a href="#" class="btn btn-success"  onclick="$('#pg').val('app_orders');$('#view').val('');$('#class_call').val('update');$('#ekeys').val('2');$('#keys').val('<?php echo $result['CHKOUT_CODE']; ?>');document.myform.submit();">Delivered</a>
              </div>
            </div>
          </div>
        </div>
