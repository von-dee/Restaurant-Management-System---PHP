        ...
        <div class="ms-quickbar-container ms-scrollable">
          ...
          <div class="ms-card ms-qa-card ms-deletable">
            ...
            <div class="ms-card-body">
              ...
              <ul class="ms-note-members clearfix mb-0">
                <li class="ms-deletable"> <img src="media/img/people/people-3.jpg" alt="member"> </li>
                <li class="ms-deletable"> <img src="media/img/people/people-5.jpg" alt="member"> </li>
              </ul>
            </div>
            <div class="ms-card-footer clearfix">
                  ...
                  <li class="ms-scrollable ms-dropdown-list ms-members-list">
                    <a class="media p-2" href="#">
                      <div class="mr-2 align-self-center">
                        <img src="media/img/people/people-10.jpg" class="ms-img-round" alt="people">
                      </div>
                    ...
                    <a class="media p-2" href="#">
                      <div class="mr-2 align-self-center">
                        <img src="media/img/people/people-9.jpg" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body">
                    ...
                    <a class="media p-2" href="#">
                      <div class="mr-2 align-self-center">
                        <img src="media/img/people/people-7.jpg" class="ms-img-round" alt="people">
                      </div>
                      <div class="media-body">
          ...
          <div class="ms-card ms-qa-card ms-deletable">
            ...
            <div class="ms-card-body">
              ...
              <ul class="ms-note-members clearfix mb-0">
                <li class="ms-deletable"> <img src="media/img/people/people-9.jpg" alt="member"> </li>
              </ul>
            </div>
            <div class="ms-card-footer clearfix">
